    <!-- Start Form -->
        ...
        echo form_open_multipart('settings/update', $attributes); ?>
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 control-label"><?=lang('automatic_updates')?></label>
                        <div class="col-lg-3">
                            <label class="switch">
                                <input type="hidden" value="off" name="automatic_updates" />
                                <input type="checkbox" <?php if(config_item('automatic_updates') == 'TRUE'){ echo "checked=\"checked\""; } ?> name="automatic_updates">
                                <span></span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 control-label"><?=lang('automatic_bug_fixes')?></label>
                        <div class="col-lg-3">
                            <label class="switch">
                                <input type="hidden" value="off" name="automatic_bug_fixes" />
                                <input type="checkbox" <?php if(config_item('automatic_bug_fixes') == 'TRUE'){ echo "checked=\"checked\""; } ?> name="automatic_bug_fixes">
                                <span></span>
                            </label>
                        </div>
                    </div>
